  ...
  if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
      ...
      if (isValid) {
        ...
        successMessage.style.cssText = 'color: green; margin-top: 10px; padding: 10px; background: #d4edda; border-radius: 4px;';
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Functional Medicine Israel uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '563a2c2c-3fb2-4653-96cc-3b2fde207db7',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '563a2c2c-3fb2-4653-96cc-3b2fde207db7';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '563a2c2c-3fb2-4653-96cc-3b2fde207db7';
